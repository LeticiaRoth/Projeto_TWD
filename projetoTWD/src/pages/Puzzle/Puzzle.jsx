  ...
  useEffect(() => {
    if (personagemSelecionado !== null && localSelecionado !== null) {
      if (personagemSelecionado === localSelecionado) {
        ...
        // Se estiver errado, ativa o erro e limpa a seleção apos um tempinho
        setErroAtivo(true);
        setTimeout(() => {
          setErroAtivo(false);
          setPersonagemSelecionado(null);
  ...
  return (
    <>
      ...
      <main className="telaPuzzle">
        ...
        {/* Feedback de Vitória, quando o negan é desbloqueado também */}
